...
#define TOKEN_WITH_SYMBOL_NOT_EXISTS "6000040 TOKEN_WITH_SYMBOL_NOT_EXISTS"//货币不存在

#define TOKEN_SYMBOL_SHOULD_EQUAL_FEE_SYMBOL "6000041 TOKEN_SYMBOL_SHOULD_EQUAL_FEE_SYMBOL"//费用和转账token应该是同一种币
