...
#define TOKEN_WITH_SYMBOL_NOT_EXISTS "6000040 TOKEN_WITH_SYMBOL_NOT_EXISTS"//货币已经存在

#define TOKEN_SYMBOL_SHOULD_EQUAL_FEE_SYMBOL "6000041 TOKEN_SYMBOL_SHOULD_EQUAL_FEE_SYMBOL"//货币已经存在
